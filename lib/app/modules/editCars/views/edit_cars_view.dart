...
class EditCarsView extends GetView<EditCarsController> {
  Data carDetails;
  EditCarsView({required this.carDetails});
  @override
  Widget build(BuildContext context) {
    final controller = Get.put(EditCarsController());
    controller.name.text = carDetails.carTitle.toString();
    controller.carModelCn.text = carDetails.modelName.toString();
    controller.priceContr.text = carDetails.price.toString();
    controller.modelYearContr.text = carDetails.manufacturingYear.toString();
    controller.currentSelectedValueTransmission.value =
        carDetails.gearTransmission.toString();
                            ...
                            children: [
                                  ...
                                  Textfields(
                                    ...
                                    fn: (str) {
                                      ...
                                      if (numericValue != null) {
                                        ...
                                        if (controller.priceContr.text !=
                                            formattedValue) {
                                          controller.priceContr.value =
                                              TextEditingValue(
                                            text: formattedValue,
                              ...
                              Row(
                                children: [
                                  ...
                                  //           numberFormat.format(numericValue);
                                  //       if (controller
                                  //               .currentMarketPriceCn.text !=
                                  //           formattedValue) {
                                  //         controller.currentMarketPriceCn
                                  ...
                                  //       }
                                  //     } else if (str.isNotEmpty) {
                                  //       controller.currentMarketPriceCn.value =
                                  //           TextEditingValue(
                                  //         text: controller
                                  //             .currentMarketPriceCn.text,
                                  //         selection: TextSelection.collapsed(
                                  //             offset: controller
                                  //                 .currentMarketPriceCn
                                  //                 .text
                                  //                 .length),
                                  //       );
                                  //     }
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: GestureDetector(
                                      onTap: () async {
                                        await controller.editCars(
                                          id: carDetails.sId,
                                            con: context,
                                               carName: controller.name.text,
                                            modelNam: controller.carModelCn.text,
                                          
                                            sellPrice: controller.priceContr.text,
                                            year: controller.modelYearContr.text,
                                   ...
                                   Padding(
                                    padding: const EdgeInsets.only(bottom: 28.0, left: 15),
                                    child: GestureDetector(
                                      onTap: () async {
                                        await controller.deleteCars(
                                          id: carDetails.sId,
                                            con: context,
                                              );
